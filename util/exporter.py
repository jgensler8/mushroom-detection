...
def _b64encoded_image_string_tensor_input_placeholder():
  """Returns input that accepts a batch of PNG or JPEG strings.
  ...
  batch_image_str_placeholder = tf.placeholder(
      dtype=tf.string,
      shape=[None],
      name='b64encoded_image_string_tensor')
  def decode(b64encoded_image_string_tensor):
    encoded_image_string_tensor = tf.decode_base64(b64encoded_image_string_tensor)
    image_tensor = tf.image.decode_image(encoded_image_string_tensor,
                                         channels=3)
    image_tensor.set_shape((None, None, 3))
    return image_tensor
...
input_placeholder_fn_map = {
    ...
    'b64encoded_image_string_tensor':
    _b64encoded_image_string_tensor_input_placeholder,
